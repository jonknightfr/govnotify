 ...
 */
public class GovNotifyNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public GovNotifyNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    public void upgrade(String fromVersion) throws PluginException {
        pluginTools.upgradeAuthNode(GovNotifyNode.class);
